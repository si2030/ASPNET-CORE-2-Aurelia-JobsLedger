...
namespace Jobsledger.API.Options
{
    public class JwtIssuerOptions
    {
        ...
        /// </summary>
        public TimeSpan ValidFor { get; set; } = TimeSpan.FromMinutes((new DateTime(DateTime.UtcNow.Year, DateTime.UtcNow.Month, DateTime.UtcNow.Day, 23, 59, 59) - DateTime.UtcNow).TotalMinutes);
        //public TimeSpan ValidFor { get; set; } = TimeSpan.FromSeconds(10);  //Testing purposes.
        /// <summary>
